...
label_result = Label(root, width=25, text="", font=("arial", 30))
label_result.pack()
...
Button(root, text="0", width=8, height=1, font=("arial", 30, "bold"), bd=1, fg='#fff', bg="#2a2d36", command=lambda:show("0")).place(x=10, y=500)
